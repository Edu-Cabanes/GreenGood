...
export default function Contact() {
  ...
  return (
    <section
      id="contacto"
      className="py-16 md:py-28 bg-brand-green px-4 text-white relative overflow-hidden"
    >
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center">
        <div className="mb-12">
          ...
          <h2 className="text-3xl md:text-5xl font-black uppercase tracking-tighter leading-none mb-6">
            Hablemos hoy <br className="hidden sm:block" /> mismo
          </h2>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
          <a
            ...
            className="inline-flex w-full sm:w-auto items-center justify-center gap-3 bg-white text-brand-green font-black text-sm md:text-lg uppercase tracking-widest px-8 py-4 md:px-10 md:py-5 rounded-2xl hover:bg-green-50 transition-all transform hover:scale-105 active:scale-95 shadow-2xl"
          >
          ...
          <a
            ...
            className="inline-flex w-full sm:w-auto items-center justify-center gap-3 bg-transparent border-2 border-white/30 text-white font-black text-sm md:text-lg uppercase tracking-widest px-8 py-4 md:px-10 md:py-5 rounded-2xl hover:bg-white/10 transition-all transform hover:scale-105 active:scale-95"
          >
        ...
        <div className="mt-16 w-full max-w-5xl mx-auto rounded-3xl overflow-hidden shadow-2xl border border-white/20">
          <iframe
            src="https://maps.google.com/maps?cid=10520740929451458510&t=&z=13&ie=UTF8&iwloc=&output=embed"
            width="100%"
            height="300"
            style={{ border: 0 }}
            allowFullScreen
